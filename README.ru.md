...
![Версия приложения](https://img.shields.io/badge/App_version-2.5.0-purple)
...
Только на сессию (персонаж, правила, софты и исключения рейдов переживают закрытие панели); строки для вставки начинаются с имени персонажа.
